<?php
    ...
    {
     echo "<table><tr><th>Number of Stations Requests</th><th>Absolute Value Requests</th><th>Mean Value Requests</th><th>Min-Max Date Requests</th><th>Available Pollutants Request</th></tr>";
    ...
    echo "<h2>Top 10 APIs with the most requests</h2>";
    ...
    {
     echo "<table><tr><th>APIkey</th><th>Username</th><th>Total Requests</th></tr>";
     // output data of each row
     $counter=0;
    ...
    echo "API keys published: " . $row["count(distinct api)"];
    $conn->close();
            ?>